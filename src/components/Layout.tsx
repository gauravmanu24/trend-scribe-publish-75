  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `flex items-center px-4 py-3 text-sm transition-colors hover:bg-gray-100 dark:hover:bg-neutral-800 rounded-lg ${
        isActive
          ? "bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 font-medium border-l-4 border-blue-600 dark:border-blue-400 pl-3"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1">
        {/* Sidebar - Made sticky */}
        <aside className="w-64 border-r border-gray-200 dark:border-gray-800 hidden md:block bg-white dark:bg-gray-900">
          <div className="h-[calc(100vh-64px)] overflow-y-auto sticky top-0 p-4">
            <h2 className="text-lg font-bold px-4 mb-6 text-gray-800 dark:text-gray-200">Dashboard</h2>
